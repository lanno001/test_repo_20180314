  ...
  <div id="abstract" class="mqc-module-section">
    ...
    <h6>
        The MinION is a portable DNA sequencer that generates long error-prone reads.
         ...
         assemblers available to MinION users, on a read set of <i>asfd</i>. This benchmark is based on a 
...
<div id="analysis_dirs_wrapper">
  <p>Report generated on 2018-03-23, 03:01 based on data in:
